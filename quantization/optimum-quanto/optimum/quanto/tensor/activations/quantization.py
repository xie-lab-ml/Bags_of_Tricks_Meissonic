...
def quantize_activation(t: torch.Tensor, qtype: qtype, scale: torch.Tensor, if_diffusion: bool = True):
    ...
    Returns:
        A quantized Tensor.
    """
    return ActivationQBytesTensor.quantize(t, qtype, scale, if_diffusion)
